...
DEU_BERLIN_KOCH_GROUP_INSTRUMENT_TO_NEXUS: dict[str, Any] = {
...
DEU_BERLIN_KOCH_GROUP_ECOLUMN_TO_NEXUS: dict[str, Any] = {
...
DEU_BERLIN_KOCH_GROUP_ESOURCE_TO_NEXUS: dict[str, Any] = {
