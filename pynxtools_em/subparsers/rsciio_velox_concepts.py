...
NX_VELOX_TO_NX_EVENT_DATA_EM = [
    (
        "/ENTRY[entry*]/measurement/event_data_em_set/EVENT_DATA_EM[event_data_em*]/start_time",
        "unix_to_iso8601",
    ...
    (
        "/ENTRY[entry*]/measurement/em_lab/EBEAM_COLUMN[ebeam_column]/electron_source/probe",
        "is",
        "electron",
    ),
    ...
    (
        "/ENTRY[entry*]/measurement/em_lab/control_program/program",
        "is",
        "Not reported in original_metadata parsed from Velox EMD using rosettasciio",
    ),
    (
        "/ENTRY[entry*]/measurement/em_lab/control_program/program/@version",
        "load_from",
    ...
    (
        "/ENTRY[entry*]/measurement/em_lab/FABRICATION[fabrication]/vendor",
        "load_from",
        "Instrument/Manufacturer",
    ),
    (
        "/ENTRY[entry*]/measurement/event_data_em_set/EVENT_DATA_EM[event_data_em*]/em_lab/EBEAM_COLUMN[ebeam_column]/electron_source/voltage",
        "load_from",
    ...
    (
        "/ENTRY[entry*]/measurement/event_data_em_set/EVENT_DATA_EM[event_data_em*]/em_lab/OPTICAL_SYSTEM_EM[optical_system_em]/camera_length",
        "load_from",
        "Optics/CameraLength",
    ),
    (
        "/ENTRY[entry*]/measurement/event_data_em_set/EVENT_DATA_EM[event_data_em*]/em_lab/OPTICAL_SYSTEM_EM[optical_system_em]/defocus",
        "load_from",
        "Optics/Defocus",
    ),
    ...
    (
        "/ENTRY[entry*]/measurement/event_data_em_set/EVENT_DATA_EM[event_data_em*]/em_lab/OPTICAL_SYSTEM_EM[optical_system_em]/magnification",
        "load_from",
    ...
    (
        "/ENTRY[entry*]/measurement/event_data_em_set/EVENT_DATA_EM[event_data_em*]/em_lab/EBEAM_COLUMN[ebeam_column]/operation_mode",
        "concatenate",
        ["Optics/OperatingMode", "Optics/TemOperatingSubMode"],
    ),
    ...
    ("", "ignore", "Sample"),
    (
        "/ENTRY[entry*]/measurement/event_data_em_set/EVENT_DATA_EM[event_data_em*]/em_lab/SCANBOX_EM[scanbox_em]/dwell_time",
        "load_from",
        "Scan/DwellTime",
    ),
    (
        "/ENTRY[entry*]/measurement/event_data_em_set/EVENT_DATA_EM[event_data_em*]/em_lab/STAGE_LAB[stage_lab]/design",
        "load_from",
        "Stage/HolderType",
    ),
    (
        "/ENTRY[entry*]/measurement/event_data_em_set/EVENT_DATA_EM[event_data_em*]/em_lab/STAGE_LAB[stage_lab]/tilt1",
        "load_from",
        "Stage/AlphaTilt",
    ),
    (
        "/ENTRY[entry*]/measurement/event_data_em_set/EVENT_DATA_EM[event_data_em*]/em_lab/STAGE_LAB[stage_lab]/tilt2",
        "load_from",
        "Stage/BetaTilt",
    ),
    (
        "/ENTRY[entry*]/measurement/event_data_em_set/EVENT_DATA_EM[event_data_em*]/em_lab/STAGE_LAB[stage_lab]/position",
        "load_from",
